...
apis:
- name: Google Civic Information - Search Political Divisions
  x-api-slug: divisions-get
  ...
  tags: Government, Google APIs, Federal Government, State Government, Stack Network,
    API Service Provider, API Provider, Profiles, Relative Data, Service API, Cities
  properties:
  - type: x-openapi-spec
...
- name: Google Civic Information - List Elections
  x-api-slug: elections-get
...
- name: Google Civic Information - Lookup Representatives
  x-api-slug: representatives-get
...
- name: Google Civic Information - Get Representative
  x-api-slug: representativesocdid-get
...
- name: Google Civic Information - Looks Up Voter Information
  x-api-slug: voterinfo-get
...
- type: x-api-stack
  url: http://google.civic.information.stack.network
